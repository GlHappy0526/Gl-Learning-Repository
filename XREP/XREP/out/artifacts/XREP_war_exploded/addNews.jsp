...
<div class="container">
    ...
    <div class="center">
        <div class="middle">
            <form action="addNews.action" style="width: 880px;height: 500px;background-color: rgba(0,0,0,0.1);text-align: center; font-size: 15px;color: lightgray;">
                <br>
                <h2>添加新闻</h2>
                <br>
                新闻标题：<input type="text" name="title"><br><br>
                新闻内容：<input type="text" name="ncontent"><br><br>
